...
function ensureRuntimeServicesStarted() {
  ...
  if (!isBuildPhase && !isTestMode && !globalDbState.__mcSchedulerInitialized) {
    globalDbState.__mcSchedulerInitialized = true
...
webhookListenerInitialized = globalDbState.__mcWebhookListenerInitialized ?? false
...
if (!globalDbState.__mcDbSignalHandlersRegistered) {
  globalDbState.__mcDbSignalHandlersRegistered = true
